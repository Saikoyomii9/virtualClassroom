...
export default function AnnouncementUpdateForm(props) {
  ...
  const [announcementRecord, setAnnouncementRecord] =
    React.useState(announcement);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(Announcement, idProp)
        : announcement;
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            Announcement.copyOf(announcementRecord, (updated) => {
    ...
    >
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || announcement)}
